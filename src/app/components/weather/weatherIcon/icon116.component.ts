...
@Component({
  selector: 'wheater-icon-116',
  template: `
    <div class="weather-icon weather-icon-2" [style.width]="width">
      <!-- shortcode: wi2 -->
      <svg viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g class="wi2-mask">
          <g>
            <rect x="30" y="83" width="50" height="11" />
            <path  
  ...
  styles: [
    `
      ...
      .weather-icon .wi2-cloud {
       
      }
      .weather-icon .wi2-rays path {
        
        stroke-width: 4.72932;
        stroke-miterlimit: 10;
        stroke-linecap: round;
      }
      .weather-icon .wi2-mask rect,
      .weather-icon .wi2-mask path {
        /* change to background color here for transparency */
        fill: #ffffff;
      }
      .weather-icon .wi2-rays {
        animation: wi2-rotate-rays 10s infinite linear;
        transform-origin: 65.90909% 48.19545%;
      }
      @keyframes wi2-rotate-rays {
        0% {
      ...
      .weather-icon .wi2-cloud {
        ...
        animation: wi2-move-cloud 4s infinite ease-in-out;
      }
      @keyframes wi2-move-cloud {
        0% {
      ...
      .weather-icon .wi2-mask path {
        transform-origin: 50.2% 59.42727%;
        animation: wi2-move-mask 4s infinite ease-in-out;
      }
      @keyframes wi2-move-mask {
        0% {
          transform: translateX(0%);
        }
        50% {
      ...
      .weather-icon .wi2-mask g rect {
        transform-origin: 50% 80.454545%;
        animation: wi2-move-mask-rect 4s infinite ease-in-out;
      }
      @keyframes wi2-move-mask-rect {
        0% {
          transform: translateX(0%);
        }
        50% {
...
export class Icon116Component implements OnInit {
