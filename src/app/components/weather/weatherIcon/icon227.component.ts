...
@Component({
  selector: 'wheater-icon-227',
  template: `
    <div class="weather-icon weather-icon-5" [style.width]="width">
      <!-- shortcode: wi5 -->
        ...
        <g class="wi5-cog">
          <g>
            <path
              ...
              d="M71.5002 82.0667C74.4591 82.0667 76.8578 79.668 76.8578 76.7091C76.8578 73.7502 74.4591 71.3515 71.5002 71.3515C68.5413 71.3515 66.1426 73.7502 66.1426 76.7091C66.1426 79.668 68.5413 82.0667 71.5002 82.0667Z"
            />
            <path [attr.stroke]="thirdColor" d="M71.5001 66.93V70.5017" />
            <path [attr.stroke]="thirdColor" d="M63 71.7981L66.0895 73.5839" />
            <path [attr.stroke]="thirdColor" d="M63 81.6204L66.0895 79.8345" />
            <path [attr.stroke]="thirdColor" d="M71.5001 86.5743V83.0026" />
            <path [attr.stroke]="thirdColor" d="M80 81.6204L76.9105 79.8345" />
            <path [attr.stroke]="thirdColor" d="M80 71.7981L76.9105 73.5839" />
          </g>
        </g>
        <path
  ...
  styles: [
    `
      ...
      .weather-icon .wi5-cloud {
      }
      .weather-icon .wi5-cog path {
        stroke-width: 4.72932;
        stroke-miterlimit: 10;
        stroke-linecap: round;
      }
      .weather-icon .wi5-cog g {
        animation: wi5-rotate-cog 7s infinite linear;
        transform-origin: 65% 69.772727%;
      }
      @keyframes wi5-rotate-cog {
        0% {
      ...
      .weather-icon .wi5-cog {
        animation: wi5-move-cog 4s infinite linear;
        transform-origin: 65% 69.772727%;
        transform: translateX(-50%);
      }
      @keyframes wi5-move-cog {
        0% {
      ...
      .weather-icon .wi5-cloud {
        ...
        animation: wi5-move-cloud 4s infinite ease-in-out;
      }
      @keyframes wi5-move-cloud {
        0% {
...
export class Icon227Component implements OnInit {
